        ...
        52294: function(e, t, n) {
            ...
            var S = function(e) {
                ...
                var me = A || pe,
                    ...
                    }), [c, h, me, S, G, w, U, K, W, V]),
                    Se = (0, o.useCallback)((function() {
                        var e = (0, s.getNextMoveIndex)(I, V, G, K, q, W, S);
                        G !== e && he(e)
                    }), [S, G, he, q, I, K, W, V]),
                    Oe = (0, o.useCallback)((function() {
                        var e = (0, s.getPrevMoveIndex)(I, V, G, q, W, S);
                        G !== e && he(e)
                    }), [S, G, he, q, I, W, V]),
                    Ce = (0, o.useRef)(L);
                (0, o.useEffect)((function() {
                    ...
                    return g && Y && clearTimeout(ge.current),
                        function() {
                ...
                var Pe = (0, o.useRef)([]),
                    we = function(e) {
                        if (ne && me.current) {
                            re(!1);
                            var t = 0;
                            if (Pe.current.length > 1)
                                for (var n = Pe.current[0], r = Pe.current[Pe.current.length - 1], o = r.time - n.time, i = 9 * Math.abs((r.pos - n.pos) / o); Math.abs(i) > 1;) t += i, i *= .92;
                            Pe.current = [];
                            ...
                            if (a < l) he(G);
                                ...
                                for (var c = W >= 2 * q ? 1 + Math.floor((a - l) / u) : 1, f = G, d = 0; d < c; d += 1) f = ie > 0 ? (0, s.getNextMoveIndex)(I, V, f, K, q, W, S) : (0, s.getPrevMoveIndex)(I, V, f, q, W, S);
                                f !== G && R(e), he(f)
                            }
                        }
                    },
                    ...
                    Me = (0, o.useCallback)((function(e) {
                        if (ne) {
                            for (var t = null === se.current, n = null !== se.current ? e - se.current : 0, r = ie + n, o = Date.now(); Pe.current.length > 0 && !(o - Pe.current[0].time <= 100);) Pe.current.shift();
                            Pe.current.push({
                                pos: r,
                                time: o
                            }), t || ae(r), se.current = e
                ...
                return o.default.createElement("div", {
                    ...
                    ariaLive: g && !Y ? "off" : "polite",
                    message: _({
                        currentSlide: G,
                        count: K
                    })
                }), (0, l.default)(t, K, G, he, Se, Oe, q), o.default.createElement("div", {
                    className: ["slider-frame", P || ""].join(" ").trim(),
                    style: v({
                        overflow: "hidden",
                        width: "100%",
                        position: "relative",
                ...
                l = function(e) {
                    ...
                    (0, o.useEffect)((function() {
                        ...
                        if (e) {
                            ...
                            var r = P.current;
                            O && !r ? b(S, n) : !O && r && b(S, null), P.current = O
                        }
                    }), [m, S, O, b, g]);
                    var w = l && O ? " slide-current" : "";
                    return o.default.createElement("div", {
                        ref: C,
                        className: "slide".concat(w).concat(c ? " ".concat(c) : "").concat(O ? " slide-visible" : ""),
