    ...
    [5224, 1664, 5063], {
        ...
        48418: function(e, t, o) {
            ...
            var b = a.default.forwardRef((function(e, t) {
                ...
                o = h, !R || "string" !== typeof o && "number" !== typeof o || (o = a.default.createElement("a", null, o));
                var E = !1 !== g,
                    k = a.default.useContext(c.RouterContext),
                    S = a.default.useContext(i.AppRouterContext);
                S && (k = S);
                var T, D = a.default.useMemo((function() {
                        var e = n(l.resolveHref(k, r, !0), 2),
                            t = e[0],
                            o = e[1];
                        return {
                            href: t,
                            as: b ? l.resolveHref(k, b) : o || t
                        }
                    }), [k, r, b]),
                    I = D.href,
                    U = D.as,
                ...
                var N = R ? T && "object" === typeof T && T.ref : t,
                    A = n(s.useIntersection({
                        rootMargin: "200px"
                    }), 3),
                    H = A[0],
                    K = A[1],
                    G = A[2],
                    q = a.default.useCallback((function(e) {
                        B.current === U && Z.current === I || (G(), B.current = U, Z.current = I), H(e), N && ("function" === typeof N ? N(e) : "object" === typeof N && (N.current = e))
                    }), [U, N, I, G, H]);
                ...
                var z = {
                    ref: q,
                    onClick: function(e) {
                        R || "function" !== typeof M || M(e), R && T.props && "function" === typeof T.props.onClick && T.props.onClick(e), e.defaultPrevented || function(e, t, o, n, r, u, f, c, i, s) {
                    ...
                    onMouseEnter: function(e) {
                        R || "function" !== typeof x || x(e), R && T.props && "function" === typeof T.props.onMouseEnter && T.props.onMouseEnter(e), !E && S || l.isLocalURL(I) && y(k, I, U, {
                            priority: !0
                        })
                    },
                    onTouchStart: function(e) {
                        R || "function" !== typeof P || P(e), R && T.props && "function" === typeof T.props.onTouchStart && T.props.onTouchStart(e), !E && S || l.isLocalURL(I) && y(k, I, U, {
                            priority: !0
                        })
                    }
                };
                if (!R || O || "a" === T.type && !("href" in T.props)) {
                    var F = "undefined" !== typeof m ? m : k && k.locale,
                        J = k && k.isLocaleDomain && p.getDomainLocale(U, F, k.locales, k.domainLocales);
                    z.href = J || d.addBasePath(f.addLocale(U, F, k && k.defaultLocale))
                }
                return R ? a.default.cloneElement(T, z) : a.default.createElement("a", Object.assign({}, w, z), o)
            }));
